...
class __$$SuccessResultCopyWithImpl<T, $Res>
    extends _$ResultCopyWithImpl<T, $Res, _$SuccessResult<T>>
...
class _$SuccessResult<T> extends SuccessResult<T> {
  const _$SuccessResult(this.value) : super._();
...
abstract class SuccessResult<T> extends Result<T> {
  const factory SuccessResult(final T value) = _$SuccessResult<T>;
...
/// @nodoc
abstract class _$$FailureResultCopyWith<T, $Res> {
  factory _$$FailureResultCopyWith(
          _$FailureResult<T> value, $Res Function(_$FailureResult<T>) then) =
      __$$FailureResultCopyWithImpl<T, $Res>;
  @useResult
...
/// @nodoc
class __$$FailureResultCopyWithImpl<T, $Res>
    extends _$ResultCopyWithImpl<T, $Res, _$FailureResult<T>>
    implements _$$FailureResultCopyWith<T, $Res> {
  __$$FailureResultCopyWithImpl(
      _$FailureResult<T> _value, $Res Function(_$FailureResult<T>) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$FailureResult<T>(
      null == failure
          ? _value.failure
...
class _$FailureResult<T> extends FailureResult<T> {
  const _$FailureResult(this.failure) : super._();
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$FailureResultCopyWith<T, _$FailureResult<T>> get copyWith =>
      __$$FailureResultCopyWithImpl<T, _$FailureResult<T>>(this, _$identity);
...
abstract class FailureResult<T> extends Result<T> {
  const factory FailureResult(final Failure failure) = _$FailureResult<T>;
